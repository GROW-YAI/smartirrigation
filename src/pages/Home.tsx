...
const Home: React.FC = () => {
  ...
  const features: Feature[] = [
    {
      ...
      description: "Automates watering using real-time data from soil moisture sensors and environmental conditions.",
      details: "Our Smart Irrigation System ensures optimal irrigation with minimal effort. Save water, boost crop productivity, and reduce operational costs. Easy to install, customizable for various farm sizes, and perfect for backyard farmers, small-scale farmers, and gardening enthusiasts.",
    },
    {
      icon: "home",
      title: "Home Automation Solutions",
      description: "Affordable and efficient systems to automate home functions, enhancing comfort and reducing energy consumption.",
      details: "Locally designed and user-friendly systems that improve security, enable remote control of appliances, and save energy. Scalable solutions suitable for homeowners, real estate developers, and urban planners.",
    },
    {
      icon: "directions_bike",
      title: "Vehicle and Motorbike Tracking Systems",
      description: "GPS-based solutions for real-time tracking and fleet management of vehicles and motorbikes.",
      details: "Compact, long-lasting, and reliable tracking systems that enhance vehicle security and provide better fleet management. Ideal for logistics companies, fleet operators, and private vehicle owners.",
    },
    {
      icon: "electric_car",
      title: "Electric Vehicles (EVs)",
      description: "Development of sustainable, locally assembled electric mobility solutions for Africa.",
      details: "Affordable, eco-friendly vehicles tailored to regional needs. Enjoy reduced emissions, lower operational costs, and greater energy efficiency. Designed for eco-conscious individuals, urban commuters, and businesses investing in green technology.",
    },
    {
      icon: "school",
      title: "Human Training and Capacity Building",
      description: "Hands-on training programs to equip individuals with practical knowledge and skills in emerging technologies.",
      details: "Focused on African-specific challenges, these programs empower young innovators to create and deploy solutions, build a sustainable talent pool, and provide certifications to enhance career opportunities. Perfect for students, early-career professionals, and technology enthusiasts.",
    },
    {
      icon: "analytics",
      title: "Real-Time Data",
      description: "Access soil health, moisture levels, and environmental conditions directly on your device.",
      details: "With real-time analytics, stay informed about your farm's health. Our sensors provide instant updates on moisture levels, temperature, and nutrient content, giving you the data to make smart decisions.",
    },
  ];

  const openModal = (feature: Feature): void => {
  ...
  return (
    <section className="bg-gray-50 min-h-screen flex flex-col items-center pt-14">
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <p className="text-lg sm:text-lg md:text-xl text-gray-100">
              Deep understanding of Africa&rsquo;s unique challenges. Locally designed
      ...
      {/* Features Section */}
      <div className="py-16 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-white to-gray-50 w-full">
        ...
        <p className="text-lg text-center text-gray-600 mt-4 max-w-2xl mx-auto">
          Discover innovative solutions designed to make life smarter, greener, and more efficient.
        </p>
      ...
      <div className="bg-gray-100 py-16 px-4 sm:px-6 md:px-12 lg:px-24 w-full">
        ...
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-7xl mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <p className="text-gray-600 italic">
              "The automated irrigation system has completely transformed my farm! I no longer have to guess when to water."
            </p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <p className="text-gray-600 italic">
              "With real-time data at my fingertips, I'm able to manage my crops better than ever before."
            </p>
            <div className="mt-4 flex items-center space-x-4">
              <img
                src={Farmer2}
